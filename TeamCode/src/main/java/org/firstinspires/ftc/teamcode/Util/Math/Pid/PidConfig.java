...
public class PidConfig {
    ...
    public PidConfig(double kp, double ki, double kd, double kf0,double kf1,double kf2,double kf3, double maxI, double zeroBorder) {
        this.kp = kp;
        this.ki = ki;
        this.kd = kd;
        this.kf0 = kf0;
    ...
    public void copyFrom(PidConfig status) {
        this.kp = status.kp;
        this.ki = status.ki;
        this.kd = status.kd;
        this.kf0 = status.kf0;
